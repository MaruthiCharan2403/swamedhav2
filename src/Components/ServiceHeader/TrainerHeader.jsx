...
export default function TrainerHeader({ setIsMenuOpen }) {
    return (
        <>
            {/* Desktop Menu */}
            <ul className="items-stretch font-bold hidden space-x-3 lg:flex">
                <li className="flex">
                    <Link to="/trainerdashboard" className="flex items-center px-4 border-b-2 border-transparent hover:border-amber-600 focus:border-amber-600">
                        Dashboard
                    </Link>
                </li>
            </ul>
