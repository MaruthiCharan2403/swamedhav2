...
const EditLevelPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`/api/course/${id}`, levelData, {
                headers: {
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-8 pt-32">
            ...
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
                <h1 className="text-3xl font-bold text-center mb-6 text-indigo-700">Edit Level</h1>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                        {terms.map((term, termIndex) => (
                            <div key={termIndex} className="bg-white p-4 rounded-lg border border-gray-200">
                                <div className="flex justify-between items-center mb-4">
                                    <h2 className="text-xl font-semibold text-indigo-600">Term {termIndex + 1}</h2>
                                ...
                                <div className="mt-4 space-y-4">
                                    {term.topics.map((topic, topicIndex) => (
                                        <div key={topicIndex} className="bg-white p-4 rounded-lg border border-gray-200">
                                            <div className="flex justify-between items-center mb-2">
                                                <h3 className="text-lg font-semibold text-indigo-500">Topic {topicIndex + 1}</h3>
                                                <div className="flex space-x-2">
                                                    <button
                                                        type="button"
                                            ...
                                            <div className="mt-4 space-y-4">
                                                {topic.contents.map((content, contentIndex) => (
                                                    <div key={contentIndex} className="bg-white p-4 rounded-lg border border-gray-200">
                                                        <div className="flex justify-between items-center mb-2">
                                                            <h4 className="text-md font-semibold text-indigo-400">Content {contentIndex + 1}</h4>
                                                            <div className="flex space-x-2">
                                                                <button
                                                                    type="button"
